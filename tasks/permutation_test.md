...
Start with the [permutation_test.py](https://github.com/ufal/npfl129/tree/past-2526/labs/12/permutation_test.py)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/permutation_test_1.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/permutation_test_2.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/permutation_test_3.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/permutation_test_4.svgz)
#### Tests End:
