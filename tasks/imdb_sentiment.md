### Assignment: imdb_sentiment
#### Date: Deadline: Nov 19, 22:00
#### Points: 3 points

Using the [imdb_sentiment.py](https://github.com/ufal/npfl129/tree/past-2526/labs/06/imdb_sentiment.py)
...
containing only words from our dataset; these embeddings are available in
ReCodEx during evaluation.
