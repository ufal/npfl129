...
#### Date: Deadline: Nov 26, 22:00
#### Points: 3 points
#### Tests: k_nearest_neighbors_tests

Starting with the [k_nearest_neighbors.py](https://github.com/ufal/npfl129/tree/past-2526/labs/07/k_nearest_neighbors.py),
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_1.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_2.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_3.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_4.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_5.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_6.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_7.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_8.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_9.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/k_nearest_neighbors_10.svgz)
#### Tests End:
