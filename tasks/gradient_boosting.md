...
#### Date: Deadline: Dec 17, 22:00
#### Points: 6 points
#### Tests: gradient_boosting_tests

Using the [gradient_boosting.py](https://github.com/ufal/npfl129/tree/past-2526/labs/10/gradient_boosting.py)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/gradient_boosting_1.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/gradient_boosting_2.svgz)
...
Using 3 trees, train accuracy: 99.2%, test accuracy: 97.8%
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/gradient_boosting_3.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/gradient_boosting_4.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/gradient_boosting_5.svgz)
#### Tests End:
