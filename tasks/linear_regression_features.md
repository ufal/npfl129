...
Starting with the
[linear_regression_features.py](https://github.com/ufal/npfl129/tree/past-2526/labs/01/linear_regression_features.py)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/linear_regression_features_1.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/linear_regression_features_2.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/linear_regression_features_3.svgz)
#### Tests End:
