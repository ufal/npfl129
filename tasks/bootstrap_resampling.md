...
Start with the [bootstrap_resampling.py](https://github.com/ufal/npfl129/tree/past-2526/labs/12/bootstrap_resampling.py)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/bootstrap_resampling_1.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/bootstrap_resampling_2.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/bootstrap_resampling_3.svgz)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/bootstrap_resampling_4.svgz)
#### Tests End:
