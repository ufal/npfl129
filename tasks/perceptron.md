...
Starting with the [perceptron.py](https://github.com/ufal/npfl129/tree/past-2526/labs/03/perceptron.py)
...
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/perceptron_1.svgz)

2. `python3 perceptron.py --data_size=50 --seed=320`
```
Learned weights -2.30 -1.96 -2.00
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/perceptron_2.svgz)

3. `python3 perceptron.py --data_size=200 --seed=92`
```
Learned weights 4.43 1.54 -2.00
```
![Test visualization](//ufal.mff.cuni.cz/~courses/npfl129/2526/tasks/figures/perceptron_3.svgz)
#### Tests End:
