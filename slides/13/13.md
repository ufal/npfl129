...
Assume we have some theory and want to convince others that it holds (like
_string theory holds_). While disproving the theory might be easier (it is enough to find
...
as described by the following paper:
