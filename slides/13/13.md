...
* There high-stake applications of ML: decision making (in public and business administration)
...
* Metrics might not capture everything we need
  ...
  * Overall accuracy might hide bad performance for a specific minority
...
* Non-profit [algotransparency.org](https://www.algotransparency.org) monitors
  stats on YouTube recommendations: 2016-2018 most recommended videos were
  claiming that were supporting alternative narrative on political events (US
  and French elections, mass shootings)
