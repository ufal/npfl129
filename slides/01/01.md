...
- More advanced neural networks (and how ChatGPT works) – this is covered in
  [NPFL114](https://ufal.mff.cuni.cz/courses/npfl114)
...
Therefore, “weights” often both weights and biases.
...
and $→t ∈ ℝ^N$ the vector of target values, we can it as
$$\tfrac{1}{2}\|⇉X→w - →t\|^2,$$
~~~
because
