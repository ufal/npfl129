...
~~~
If we want to compute all (or many) principal components, we can directly compute
...
Clustering is an unsupervised machine learning technique, when given input
