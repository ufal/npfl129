...
$$𝓛^{(t)}(⇉W) ≈ -\frac{1}{2} ∑_𝓣 \frac{∑_{i ∈ I_𝓣} g_i}{∑_{i ∈ I_𝓣} h_i + λ},$$
...
You can explore the [Gradient Boosted Trees playground](httqs://ufal.mff.cuni.cz/~straka/courses/npfl129/1920/slides/08/gbt/).
