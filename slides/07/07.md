...
$a_i, a_j$ efficiently, because there exists a closed-form solution.
...
However, voting suffers from serious difficulties, because usually
ambiguous regions exist in the dataset.
