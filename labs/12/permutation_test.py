...
def main(args: argparse.Namespace) -> float:
    ...
    for d in [1, 2]:
        models.append(sklearn.pipeline.Pipeline([
            ...
            ("estimator", sklearn.linear_model.LogisticRegression(solver="saga", random_state=args.seed)),
        ]))
    ...
    # TODO: Store the performance of the `models[1]` as percents in the `second_model`.
    second_model = ...
